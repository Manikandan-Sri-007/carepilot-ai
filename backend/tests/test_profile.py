...
class ProfileEndpointTests(unittest.TestCase):
    ...
    def test_profile_can_be_updated_and_retrieved(self):
        ...
        profile_update_response = self.client.post(
            "/profile",
            json={"age": 34, "gender": "Female", "profile_details": "Prefers evening follow-ups"},
        ...
        self.assertEqual(profile_response.json()["profile_details"], "Prefers evening follow-ups")
    ...
    def test_registration_login_jwt_and_dashboard_flow(self):
        ...
        self.assertEqual(register_response.status_code, 200)
        self.assertEqual(register_response.json()["email"], "jordan@example.com")
        ...
        self.assertIn("access_token=", login_response.headers["set-cookie"])
